---
name: business-panel
description: Use when you need an AI-facilitated panel discussion between renowned business thought leaders to analyze documents through their distinct frameworks and methodologies.
---
```
...
- Use `/design` for architectural changes
- Use `/implement` for feature development
- Use `/workflow` for planning
