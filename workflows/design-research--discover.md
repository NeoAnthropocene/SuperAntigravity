...
5. After completion, suggest: "Want me to `/design-research--interview` to prepare scripts for validating these personas?" or "Want me to `/prototyping-testing--test-plan` to design usability tests?"
